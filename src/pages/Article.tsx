...
const Article = () => {
  ...
  const getCategoryClass = (cat: string) => {
    ...
    if (normalized === "stories") return "tag-stories";
    if (normalized === "journals") return "tag-journals";
    if (normalized === "illustrations") return "tag-illustrations";
    return "tag-stories";
  };
  ...
  return (
    <>
      <Helmet>
        <title>{article.title} — Sulung Arung</title>
        <meta name="description" content={article.subtitle} />
        <meta property="og:title" content={`${article.title} — Sulung Arung`} />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            publisher: { "@type": "Organization", name: "Sulung Arung" },
          })}
        </script>
      </Helmet>
        ...
        <main>
          ...
          <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 -mt-32 relative z-10">
            ...
            <div className="mb-12 pb-12 border-b border-border">
              <div className="flex flex-wrap gap-3">
                {article.tags.map((tag) => (
                  <span key={tag} className="px-4 py-2 rounded-full text-sm bg-muted text-foreground">
                    #{tag}
                  </span>
                ))}
              </div>
            ...
            <div className="md:hidden mb-12 pb-12 border-b border-border">
              <p className="text-sm font-semibold mb-4">Share this story</p>
            ...
            <div className="mb-16 rounded-2xl bg-card p-8 md:p-12 text-center">
              <h3 className="text-2xl md:text-3xl font-bold mb-4">Enjoyed this story?</h3>
              <p className="text-muted-foreground mb-6">
                Subscribe to receive new stories and journals directly in your inbox.
              </p>
            ...
            {/* Comments Section */}
            <CommentsSection storyId={article.id} />
          </article>
          ...
          {relatedArticles.length > 0 && (
            <section className="bg-muted py-16 animate-fade-in">
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <h2 className="text-3xl font-bold mb-8 animate-slide-up">You might also enjoy</h2>
